...
import { removeItemFromCart, updateItemInCart } from "@/libs/features/cart/CartSlice";
...
const Cart = () => {
  ...
  const handleQuantity = (productId, type) => {
    ...
    if (type === "minus" && newQuantities[productId] > 1) {
      ...
      dispatch(updateItemInCart({ _id: productId, quantity: newQuantities[productId] }));
    }
    if (type === "plus") {
      ...
      <MaxWidthWrapper>
        <div className="wrapper min-h-screen pt-32 text-black">
          <div className="flex gap-5">
            ...
            {/* cart details */}
        {
          isClient &&     <div className="basis-3/4 border-r pr-5 border-dotted border-black">
          <div className="text-4xl font-semibold pb-4">Cart</div>
          <div className="flex flex-col gap-2 border-b border-dotted border-black">
            {/* headers */}
            <div className="grid grid-cols-4 border-b border-dotted border-black p-2">
